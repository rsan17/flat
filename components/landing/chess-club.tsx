      ...
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-10 px-6 py-20 md:grid-cols-12">
        <div className="md:col-span-6">
          ...
          <p className="mt-6 text-lg">
            Це простір, де грають, вчаться і знайомляться. Тут усе
            відбувається природньо і має своє продовження.
          </p>
          <p className="mt-4 text-lg">
            Не обов&apos;язково бути профі — можна прийти з нуля або після довгої
            паузи. Поруч люди, які завжди підкажуть і допоможуть освоїтись.
          </p>
