      ...
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-10 px-6 py-20 md:grid-cols-12">
        <div className="md:col-span-6">
          ...
          <p className="mt-6 max-w-md text-lg">
            Без турнірної сухості. Живий вайб, нові знайомства, азарт гри.
            Шахи — і не тільки.
          </p>
          ...
          <div className="mt-8 space-y-4">
            <ClubPerk
              tag="регулярно"
              text="Лекції від досвідчених гравців, турніри, булет-батли, онлайн-ігри, парні й п'яні шахи."
            />
            <ClubPerk
              tag="кодекс"
              text="Повага до гравців і до дому — Flat5. Тусовка для своїх, без токсичності."
            />
            <ClubPerk
              tag="бонус"
              text="Карта лояльності Flat5 — 5% кешбеку на всі замовлення замість стандартних 2%."
            />
          </div>
        </div>
